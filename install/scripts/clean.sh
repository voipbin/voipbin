#!/bin/bash
# VoIPBin Install - Cleanup Script
...
main() {
    ...
    [ "$PURGE" = true ] && actions+=("Generated files purged (.env, docker-compose.yml, versions.lock, certs, configs)")
